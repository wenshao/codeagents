...
**进展**：[PR#3087](https://github.com/QwenLM/qwen-code/pull/3087)（open，LaZzyMan）— `managed auto-memory + auto-dream system`。PR 标题显式包含 dream，覆盖本 item（Auto Dream 记忆整理）+ [item-4 会话记忆](#item-4)（extract 提取）两部分：
