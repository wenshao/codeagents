...
### 35. toolUseSummary 工具使用摘要服务（P3）

**做什么**：Claude Code 的 toolUseSummary 服务——生成工具使用摘要：

**关键源码**：

| 文件 | 行数 | 职责 |
|------|------|------|
| `services/toolUseSummary/` | 112 | 工具使用摘要生成 |

**Qwen Code 现状**：Qwen Code **没有工具使用摘要服务**。

**Qwen Code 修改方向**：新建 `services/toolUseSummary/`。
