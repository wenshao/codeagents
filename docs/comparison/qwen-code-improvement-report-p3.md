...
### 32. useDirectConnect 直连 Hook（P3）
...
### 33. useHistorySearch 历史搜索 Hook（P3）
...
### 34. useManagePlugins 插件管理 Hook（P3）
...
### 35. useTaskListWatcher 任务列表监控（P3）

**做什么**：Claude Code 的 useTaskListWatcher Hook——监控后台任务列表变化：
...
### 36. useVoiceIntegration 语音集成 Hook（P3）
