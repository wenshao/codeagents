...
### 35. useVimInput Vim 输入 Hook（P3）

**做什么**：Claude Code 的 useVimInput Hook——Vim 模式输入处理：

**关键源码**：

| 文件 | 行数 | 职责 |
|------|------|------|
| `hooks/useVimInput.ts` | 316 | Vim 输入处理 |

**Qwen Code 现状**：Qwen Code 有 Vim 模式，但**没有专门的 useVimInput Hook**。

**Qwen Code 修改方向**：新建 `hooks/useVimInput.ts`。
...
### 37. useLspPluginRecommendation LSP 插件推荐（P3）

**做什么**：Claude Code 的 useLspPluginRecommendation Hook——根据项目推荐 LSP 插件：

**关键源码**：

| 文件 | 行数 | 职责 |
|------|------|------|
| `hooks/useLspPluginRecommendation.ts` | 193 | LSP 插件推荐 |

**Qwen Code 现状**：Qwen Code **没有 LSP 插件推荐功能**。

**Qwen Code 修改方向**：新建 `hooks/useLspPluginRecommendation.ts`。
...
### 38. unifiedSuggestions 统一建议（P3）

**做什么**：Claude Code 的 unifiedSuggestions Hook——统一建议展示：

**关键源码**：

| 文件 | 行数 | 职责 |
|------|------|------|
| `hooks/unifiedSuggestions.ts` | 202 | 统一建议展示 |

**Qwen Code 现状**：Qwen Code **没有统一建议展示功能**。

**Qwen Code 修改方向**：新建 `hooks/unifiedSuggestions.ts`。
...
### 39. useIdeSelection IDE 选择 Hook（P3）
