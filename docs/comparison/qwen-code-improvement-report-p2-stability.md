...
**Qwen Code 现状**：`MarkdownDisplay.tsx` 的表格渲染在 CJK/ANSI 混合场景列对齐不准确——中文表格基本不可读。
...
**进展**：[PR#2914](https://github.com/QwenLM/qwen-code/pull/2914)（open）— 重写 `TableRenderer` 为单字符串块渲染，修复 CJK/ANSI 列宽、长内容换行、对齐标记支持。
...
**进展**：[PR#2889](https://github.com/QwenLM/qwen-code/pull/2889)
