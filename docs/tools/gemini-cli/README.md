...
> Google 官方终端 AI 编程代理（Qwen Code 上游）

| 文档 | 内容 |
|------|------|
| [01-概述](./01-overview.md) | 元数据、核心功能、Monorepo 结构、安装、模型支持、优劣势、使用场景、定价、资源链接 |
| [02-命令详解](./02-commands.md) | 41 个斜杠命令完整列表、CLI 参数与启动方式 |
| [03-技术架构](./03-architecture.md) | AgentSession 架构图、调度器状态机、模型路由器（7 策略）、配置系统（TOML）、技术栈、沙箱、认证 |
