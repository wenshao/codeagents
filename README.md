...
| **[OpenCode 对标改进（27 项）](./docs/comparison/qwen-code-opencode-improvements.md)** | 文件时间锁 + Session Fork + SQLite 持久化 |
...
| [OpenCode 对标改进（27 项）](./docs/comparison/qwen-code-opencode-improvements.md) | 文件时间锁 + Session Fork + SQLite |
