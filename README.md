...
| **[Qwen Code 改进报告（260 项）](./docs/comparison/qwen-code-improvement-report.md)** | Claude Code 对比 + 52 个社区 PR 追踪（56 已合并） |
...
| 报告 | 说明 |
|------|------|
| [Claude Code 对比（260 项）](./docs/comparison/qwen-code-improvement-report.md) | 改进建议 + 52 个社区 PR 追踪（56 已合并） |
| [Gemini CLI backport（53 项）](./docs/comparison/qwen-code-gemini-upstream-report.md) | 上游可 backport 改进 + 模块级架构对比 |
| [/review 功能分析](./docs/comparison/qwen-code-review-improvements.md) | 审查功能 5 方对比（含 gstack） |
