...
> 基于源码分析和二进制反编译的 19 款 AI 编程 Code Agent 全面对比 + 6 款 Agent Framework 对比 | 385 文件 | 107,000+ 行 | 155 篇 Deep-Dive | 12 个 EVIDENCE.md | 4 家月度进展分析 + 战略全景
...
| 入口 | 说明 |
|------|------|
| **[Deep-Dive 索引（155 篇）](./docs/comparison/deep-dive-index.md)** | 按主题分类的全部深度分析文章 |
